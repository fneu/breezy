...
" applied after g:airline#themes#breezy#palette.normal, hence why only certain keys are
" declared.
...
let s:R1   = [ '#cfcfc2' , '#b33939' , 17  , 190 ]
let s:R2   = [ '#7a7c7d' , '#232629' , 255 , 238 ]
let s:R3   = [ '#a5a6a8' , '#31363b' , 85  , 234 ]
let g:airline#themes#breezy#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)
" let g:airline#themes#breezy#palette.replace = copy(g:airline#themes#breezy#palette.insert)
" let g:airline#themes#breezy#palette.replace.airline_a = [ s:I2[0]   , '#af0000' , s:I2[2] , 124     , ''     ]
" let g:airline#themes#breezy#palette.replace_modified = g:airline#themes#breezy#palette.insert_modified
